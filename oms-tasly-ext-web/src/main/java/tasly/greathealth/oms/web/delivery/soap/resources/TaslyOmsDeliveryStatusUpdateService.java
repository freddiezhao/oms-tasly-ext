...
public interface TaslyOmsDeliveryStatusUpdateService
{

	/**
	 *
	 * Delivery Number/Delivery company ID
	 * Return nothing
	 *
	 * @param baseinfo
	 * @param message
	...
	@WebMethod
	@Oneway
	public void updateOrderStatus4Delivery(@WebParam(name = "baseinfo") Baseinfo baseinfo,
